...
// Fecha sessões abandonadas por perda de heartbeat (> 20 segundos)
try {
...
// Busca convidados na Sala de Espera (status = 'waiting')
$waiting = [];
$user = current_user();
if ($user && !empty($user['active']) && (int)$user['id'] === (int)$me['owner_user_id']) {
try {
