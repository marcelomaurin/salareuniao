...
<div class="top"><div><h1>Administração do sistema</h1><div class="muted">Visão global de usuários, salas, presença e sinalização.</div></div><div class="nav"><a href="admin_users.php">Usuários</a><a href="admin_devices.php">Dispositivos</a><a href="admin_firmware.php">Firmware</a><a href="admin_audit.php">Auditoria</a><a href="admin_system.php">Diagnóstico</a><a href="index.php">Área do usuário</a><a href="logout.php">Sair</a></div></div>
